...
wordpress plugin hide admin bar toolbar adding global options to hidding front end adminbar according logged in administrator and users roles profiles

== Description ==

This wordpress plugin <a href="https://wordpress.org/plugins/toolbar-removal-completely-disable/">Hide Admin Bar and Toolbar</a> add global options for hide the front end admin bar or toolbar according to logged in administrator and user roles. To disable the back end use instead <a href="https://wordpress.org/plugins/toolbar-removal-completely-disable/">Disable Admin Bar and Toolbar</a> extension or waiting the next coming soon features - Build 2016-01-05 - To remove completely both front end and backend Admin Bar or Toolbar for all users roles use <a href="https://wordpress.org/plugins/wp-admin-bar-removal/">WP Admin Bar Removal</a> or <a href="https://wordpress.org/plugins/wp-toolbar-removal/">WP Toolbar Removal</a> plugins.
