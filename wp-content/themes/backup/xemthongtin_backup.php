		...
		elseif(is_user_logged_in()&&$check >0&&$_GET['capnhat']!=yes) { 
			 ...
			 ?>
				<body>
						  ...
						  <div class="container">
						    ...
						    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						      <ul class="nav navbar-nav">
						        ...
						        <li><a href="<?php echo home_url().'/cap-nhat-thong-tin' ?>" title="Cập nhật"><span class="fa fa-refresh fa-spin"></span> Cập nhật thông tin</a></li>
						        <li><a href="<?php echo home_url().'/tim-kiem'; ?>"><span class="fa fa-search"></span> Tìm kiếm thông tin KĐV</a></li>
						      </ul>
						...
						<?php if (!empty($alert)) { ?> <div class="alert alert-info" style="text-align:center"> <?php echo $alert; ?> </div> <?php } ?>
						<div class="container">
							...
							<div class="content">		
									...
									<?php if ($selectthongtinchung[15]==1) {?>
										...
										<blockquote><p>Chứng chỉ đào tạo Kiểm định viên: <span style="color:red;">Số chứng chỉ: <?php echo $selectthongtinchung[16]; ?> Ngày cấp: <?php echo $selectthongtinchung[17]!='0000-00-00'? date("d-m-Y", strtotime($selectthongtinchung[18])) :''; ?></span></p></blockquote>
										</div> <!-- cckiemdinhvien -->
									<?php } ?>
