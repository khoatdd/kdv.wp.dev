...
<body>
	...
	<div class="container">
		...
		<div class="login" style="margin:10px 40px 0 40px">
			...
			<a href="<?php echo home_url().'/tim-kiem'; ?>">Quay lại trang tìm kiếm</a> 
		...
		<div class="content">
			...
			<div class="title">
				...
				<div class="chuyennganhdaotaobacthacsi">
					...
					<button class="themtrinhdothacsi btn btn-primary btn-sm" type="button" id="themtrinhdothacsi">Thêm</button>
				...
				<div class="chuyennganhdaotaobactiensi">
					...
					<button class="themtrinhdotiensi btn btn-primary btn-sm" type="button" id="themtrinhdotiensi" >Thêm</button>
				...
				<div class="thekiemdinhvien">
					<blockquote><p>Thẻ Kiểm định viên: <span style="color:red;"><b>Số thẻ:</b> <?php echo $selectthongtinchung[19]!='' ? $selectthongtinchung[19] : 'dữ liệu trống'; ?> <b>Ngày cấp:</b> <?php echo $selectthongtinchung[20]!='0000-00-00'? date("d-m-Y", strtotime($selectthongtinchung[20])) :'dữ liệu trống'; ?></span></p></blockquote>
				</div> <!-- thekiemdinhvien -->
				<div class="trinhdongoaingu">
					...
					<table class="ngoaingu table table-striped table-hover"  cellpadding="2" cellspacing="0">
						...
						<button id="buttonngoaingu" class="btn btn-primary btn-sm" type="button">Thêm</button>
			...
			<div class="title" style="margin-top:20px">
				...
				<button id="button3" class ="btn btn-primary btn-sm" type="button" >Thêm</button>
				...
				<div class="nhanxet">
					...
					<button class="themnhanxet btn btn-primary btn-sm" type="button" >Thêm</button>
				...
				<br>
					<input type="submit" value="Cập nhật" name="capnhat_KDV" id="capnhat" class="btn btn-primary btn-sm">
				</div>
