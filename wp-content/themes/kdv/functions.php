...
function kdv_scripts()
{
    ...
    /* add scripts */
    if ( is_page_template('templates/create.php') || is_page_template('templates/edit.php'))
    {
        global $wpdb;
        $donvitochuc = $wpdb->get_results
        (
            'SELECT * FROM cacdonvitochucdgn',
            ARRAY_N
        );
        wp_enqueue_script( 'jquery-custom', get_template_directory_uri() . '/js/jquery.min.js', array(), true, true  );
        wp_enqueue_script( 'jquery-ui-js', get_template_directory_uri() . '/js/jquery-ui.min.js', array(), true, true );
        wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array(), true, true );
        wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/js/custom.js', array(), true, true );
        wp_localize_script( 'custom-js', 'object', $donvitochuc );
    }
}
